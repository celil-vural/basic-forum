...
public class AuthenticationService {
    ...
    public AuthenticationResponse register(RegisterRequest request) throws UserAlreadyExists {
        boolean isUserExists=repository.findByUsername(request.getUsername()).isPresent();
        if(isUserExists){
